...
const addToHistory = async (req, res) => {
  ...
  try {
    ...
    if(!isMeeting) return res.status(httpStatus.NOT_FOUND).json({ message: "Meeting not found" });
...
export { login, register, getUserHistory, addToHistory, createMeeting, getUserName };
