...
function VideoMeet() {
  ...
  let connect = () => {
    ...
    toast.success("Connect with your loved once");
    getMedia();
  };
  ...
  const meetCode = pathName.substring(9, pathName.length);
    ...
    <div>
      ...
      {askForUsername === true ? (
        <div className={styles.lobbyContainer}>
          <h1 className={styles.title}>Join into lobby - Lobby</h1>
        ...
        <div className={styles.meetVideoContainer}>
                    ...
                    messages.map((item, index) => {
                      return (
                        <div style={{ marginBottom: "20px" }} key={index}>
                          ...
                          >
                            <AccountCircleIcon style={{ height: "20px" }} />
                            <p
          ...
          <div className={styles.buttonContainers}>
            <p style={{ color: "white" }}>{meetCode}</p>
            <IconButton
              style={{
                color: "white",
                border: "2px solid white",
